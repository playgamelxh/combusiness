...
//    print_r($arr);print_r($resArr);
    ...
    //更新投资表
    updateTouzhi($arr['cid'], $resArr['unique_id']);
...
function updateReport($arr, $unique)
{
    ...
    $url = "http://app.qichacha.com/enterprises/new/a1/getAnnualReportList?unique={$unique}&token={$token}";
    $data = getHtml($url);
